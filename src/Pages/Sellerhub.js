        ...
        <div className="main">
          ...
          <div className="getStarted-sec">
            <div className="container">
              ...
              <ul className="d-flex ul-none">
                ...
                <li>
                  <div className="getStarted-icon">
                    <img src="assets/images/List-it-icon.png" alt="" className="img-fluid" />
                  </div>
                  <div className="getStarted-text">
                    <h3>List it</h3>
                    <p>List Products in your Online Store</p>
                    <a href="#">Learn more <i className="fas fa-chevron-right" /> </a>
                  </div>
                </li>
                <li>
                  <div className="getStarted-icon">
                    <img src="assets/images/Sell-it.png" alt="" className="img-fluid" />
                  </div>
                  <div className="getStarted-text">
                    <h3>Sell it</h3>
                ...
                <li>
                  ...
                  <div className="getStarted-text">
                    <h3>Ship it</h3>
                    <p>Arrange to Ship your Products to your Buyers</p>
                    <a href="#">Learn more <i className="fas fa-chevron-right" /></a>
                  </div>
                </li>
                <li>
                  ...
                  <div className="getStarted-text">
                    <h3>Get Paid</h3>
                    <p>Deposit $$$ into your Bank Account</p>
                    <a href="#">Learn more <i className="fas fa-chevron-right" /></a>
                  </div>
                </li>
              </ul>
                  ...
                  <div className="welcome-block">
                    <div className="heading-style1 buy_page">
                      ...
                      <h2 className="buy-sell-title"> 
                        <span>Watch our video</span> to learn how selling on THE XCHANGE MARKETPLACE works
                      </h2>
                    </div>
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-7">
                  <h2>SELLING on <span>the Xchange</span></h2>
                  <h4>Whether creating an e-Commerce plan or just selling used equipment, <br /> 
                    <strong>THE XCHANGE</strong> is the right place to sell and market your testing equipment</h4>
                  <div className="xchange-value">
                    <ul>
                      ...
                      <li>
                        <a href="#">Create <strong> Product Videos</strong></a>
                      </li>
                      <li>
                ...
                <div className="col-md-5 mt-5  mob-view">
                  <img src="assets/images/sell-img-3.png" alt="" className="img-fluid" />
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="whoShouldBuyWrap">
                <div className="row">
                  <div className="col-md-3 bg-whoShouldBuy">
                    <h2>Who should SELL <span>On the Xchange</span></h2>
                  ...
                  <div className="col-md-9">
                    <div className="row">
                      <div className="col-md-3">
                        <div className="wsb-list">
                          <div className="wsb-list-img">
                            <img src="assets/images/sell-icon-01.png" alt="" className="img-fluid" />
                          </div>
                          <h3>Instrument Manufacturers</h3>
                          <a href="#">Learn more </a>
                        </div>
                      </div>
                      <div className="col-md-3">
                        <div className="wsb-list">
                          <div className="wsb-list-img">
                            <img src="assets/images/sell-icon-02.png" alt="" className="img-fluid" />
                          </div>
                      ...
                      <div className="col-md-3">
                        <div className="wsb-list">
                          <div className="wsb-list-img">
                            <img src="assets/images/sell-icon-03.png" alt="" className="img-fluid" />
                          </div>
                          <h3>Companies</h3>
                          <a href="#">Learn more </a>
                        </div>
                      ...
                      <div className="col-md-3">
                        <div className="wsb-list">
                          <div className="wsb-list-img">
                            <img src="assets/images/sell-icon-04.png" alt="" className="img-fluid" />
                          </div>
                          <h3>Consumers</h3>
                          <a href="#">Learn more </a>
                        </div>
          ...
          <div className="whybuy">
            <div className="container">
              <div className="row">
                <div className="col-md-3">
                  <h2>Why SELL <span>On the Xchange</span> </h2>
                  <a className="btn btn-primary btn-sm btn-style1" href="#" role="button">Start Browsing</a>
                </div>
                <div className="col-md-9">
                  <div className="row">
                    ...
                    <div className="col-md-3 col-6">
                      <div className="wb-list text-center">
                        <div className="wb-list-img">
                          <img src="assets/images/icon-23.png" alt="" className="img-fluid" />
                        </div>
                    ...
                    <div className="col-md-3 col-6">
                      <div className="wb-list text-center">
                        <div className="wb-list-img">
                          <img src="assets/images/icon-24.png" alt="" className="img-fluid" />
                        </div>
          ...
          <div className="howToBuy">
            <div className="container">
              <div className="row">
                <div className="col-md-3">
                  <h2>How to SELL <span>on the Xchange</span></h2>
                  <a className="btn btn-primary btn-sm btn-style1" href="#" role="button">Start Browsing</a>
                </div>
                  ...
                  <div className="row">
                    <div className="col-md-3 col-6">
                      <div className="htb-prog-img">
                        <img src="assets/images/sell-pro.png" alt="" className="img-fluid" />
                      </div>
                    ...
                    <div className="col-md-3 col-6">
                      <div className="htb-prog-img">
                        <img src="assets/images/sell-pro-02.png" alt="" className="img-fluid" />
                      </div>
                    ...
                    <div className="col-md-3 col-6">
                      <div className="htb-prog-img">
                        <img src="assets/images/sell-pro-03.png" alt="" className="img-fluid" />
                      </div>
                    ...
                    <div className="col-md-3 col-6">
                      <div className="htb-prog-img">
                        <img src="assets/images/sell-pro-04.png" alt="" className="img-fluid" />
                      </div>
